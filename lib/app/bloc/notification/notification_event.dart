...
class PaymentSuccessfullEvent extends NotificationEvent {}

class PaymentFailedEvent extends NotificationEvent {}

class PaymentInitialSuccessEvent extends NotificationEvent {}

class PaymentInitialFailEvent extends NotificationEvent {}

class PaymentCancelSuccessEvent extends NotificationEvent {}

class PaymentExpireSuccessEvent extends NotificationEvent {}

class TrialExpireSuccessEvent extends NotificationEvent {}

class PaymentRenewalSuccessEvent extends NotificationEvent {}

class PaymentRenewalFailEvent extends NotificationEvent {}
